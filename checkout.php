...
<section class="checkout-orders">
   ...
   <h3>pesanan Anda</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Kabupaten :</span>
            <input type="text" name="street" placeholder="e.g. samena" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Kota :</span>
         ...
         <div class="inputBox">
            <span>Kode Pos:</span>
            <input type="text" name="state" placeholder="e.g. 16xxxxxx" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Negera :</span>
