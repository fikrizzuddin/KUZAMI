...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="price" required class="box" min="0" max="999999999999999" placeholder="masukkan harga produk" onkeypress="if(this.value.length == 15) return false;" value="<?= $fetch_products['price']; ?>">
